...
echo 'docker run --detach  --name $1  --env "VIRTUAL_HOST=$2" -e "VIRTUAL_PORT=80" -e "LETSENCRYPT_HOST=$2" /home/ubuntu:/usr/share/nginx/html:ro --restart unless-stopped nginx' > startnginx.sh
